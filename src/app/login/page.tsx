        ...
        <div className="bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[3rem] p-8 md:p-12 shadow-2xl relative group">
          ...
          <div className="relative space-y-10">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              <div className="w-20 h-20 border-2 border-blue-500 rounded-3xl flex items-center justify-center mb-2 shadow-lg shadow-blue-500/20">
                <Instagram className="w-10 h-10 text-blue-500" />
              </div>
